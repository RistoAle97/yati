class TransformerConfig:
    ...
    def __init__(
        ...
        :param vocab_size: the shared vocabulary size.
        ...
        :param tie_embeddings: whether to tie the decoder embeddings to the linear output layer (default=True).
        :param bos_token_id: the beginning of sequence token id (default=0).
